...
if (isset($_GET['id'])) {
    ...
    $detailCategory = $category->getListCategoryByID($_GET['id']);
}
?>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    ...
                                    <form action="http://localhost/Book_Review/Book_Review_Code_PHP/views/admin_site/category/index.php" method="post">
                                        <div class="product-tab-list tab-pane fade active in" id="description">
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="review-content-section">

                                                        <?php if (isset($detailCategory)) foreach ($detailCategory as $key => $value) : ?>
                                                            <div class="input-group mg-b-pro-edt">
                                                                <span class="input-group-addon"><i class="fa-solid fa-signature"></i></span>
                                                                <input name="editID" style="color: black" type="text" class="form-control" value="<?php echo $value->cateId ?>" readonly>
                                                            </div>
                                                            <div class="input-group mg-b-pro-edt">
                                                                <span class="input-group-addon"><i class="fa-solid fa-circle-info"></i></span>
                                                                <input name="editName" type="text" class="form-control" value="<?php echo $value->name ?>">
                                                            </div>
                                                        <?php endforeach ?>
